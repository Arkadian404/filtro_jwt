...
@Component({
  ...
  templateUrl: './admin-test-dialog.component.html',
  styleUrls: ['./admin-test-dialog.component.scss', '../../reusable/dialog.scss']
})
export class AdminTestDialogComponent implements OnInit{
  ...
  constructor(private formBuilder:FormBuilder,
              ...
              private matDialog:MatDialogRef<AdminTestDialogComponent>,
